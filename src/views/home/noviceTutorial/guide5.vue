<template>
  <div class="noviceTutorial1">
    ...
    <div class="content">
      ...
      <div class="novice_div_five">
        <b class="novice_close"
           @click="close"></b>
        <div class="btn">
        ...
        <div class="nav_market"></div>
        <div class="navr_list"></div>
        <div class="market_text"></div>
      </div>
    ...
    <div class="footer_navr">
      <p></p>
      <p class="market-active">
        <i>
          <svg-icon icon-class='market_active'
                    style="fill:rgb(105, 137, 255)" /></i>
        行情
      </p>
      <p></p>
      <p></p>
  ...
  .novice_div_five
    ...
    .btn
      ...
      .btn_methods
        ...
        margin 15px 20px 0
        &.look_trade
          background-image url('../../../assets/images/noviceTutorial/next.png')
          background-size cover
        &.look_course
...
.market_text
  ...
  height 182px
  margin 50px auto 0
  background-image url('../../../assets/images/noviceTutorial/five_node.png')
  background-size 100% 100%
.footer_nav, .footer_navr
  display flex
  p
    flex 0 0 20%
    text-align center
