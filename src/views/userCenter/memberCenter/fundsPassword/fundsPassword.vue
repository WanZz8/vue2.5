    ...
    <div class="mint-content userPrivileges_view">
      <div class="forget_view">
        <div class="user_header">
          <img
            src="../../../../assets/images/common/loginHeader.png"
            alt="header"
            class="user_h_img"
          >
        </div>
        ...
        <div class="password">
          ...
          <input
            :type="eye_type1?'password':'text'"
            name="pwd"
            v-model="ruleForm.password"
            placeholder="请输入密码"
          >
          <div class="eyeIcon" @click="clickEye1">
            <i class="icons icon_eye">
              <svg-icon
                :icon-class="eye_type1
                ?'eye_close'
                :'eye_open'">
              </svg-icon>
            </i>
        ...
        <div class="password">
          ...
          <input
            :type="eye_type2?'password':'text'"
            name="pwd"
            v-model="ruleForm.comfirmPwd"
            placeholder="确认密码"
          >
          <div class="eyeIcon" @click="clickEyes2">
            <i class="icons icon_eye">
              <svg-icon
                :icon-class="eye_type2
                ?'eye_close'
                :'eye_open'"
              />
            </i>
...
export default {
  ...
  methods: {
    ...
    // 获取短信验证码
    sendPhoneCode() {
      this.$store.dispatch('getFunsPhoneCode', this.ruleForm)
      this.isModalVisible = false
      this.timer()
    },
    comfirm_btn() {
