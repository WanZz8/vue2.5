<template>
  <transition name="linkSlider"
    ...
    <div class="app_Pread_page"
         v-show="linkSpreadFlat">
      <header-view :titles="'域名推广'"
                   :headerLeft='true'>
